...
unsigned long inMsg = 0;
unsigned long timeSinceZero = 0;
unsigned int msgCount = 0;
bool latencyTest = true;
    ...
    switch (messageType) { //serialInputBuffer[i] is the message type
      ...
      */
      ...
      if(end_message_flag == 1) { 
         ...
         if(latencyTest){
            inMsg = millis();
            timeSinceZero = inMsg - timeZero; //The total amount of time elapsed since the msg came in
            msgCount++;
            Serial.print(msgCount);
            Serial.print(" , ");
            Serial.print(timeSinceZero);
            Serial.print(" , ");
      ...
      case 33: //trig metronome for one motor using exp model
        ...
        if(latencyTest){
          if(msgCount > 0){
            ...
            timeZero = millis(); //This is the start of the piece of music and therefore the "zeroth" point of time
            //Serial.println("0, 0");
          }
